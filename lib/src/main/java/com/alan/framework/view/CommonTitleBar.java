...
public class CommonTitleBar extends RelativeLayout {
    ...
    private int getDefaultBackIcon() {
        return ResourceUtils.getResourceIdFromTheme(getContext(), R.attr.title_bar_back_icon, R.drawable.icon_titlebar_back);
    }

    private int getDefaultBgColor() {
        return ResourceUtils.getColorFromTheme(getContext(), R.attr.title_bar_color, Color.WHITE);
    }

    private int getDefaultTitleColor() {
        return ResourceUtils.getColorFromTheme(getContext(), R.attr.title_bar_title_color, Color.parseColor("#535353"));
    }

    private float getDefaultTitleSize() {
        return ResourceUtils.getDimissionFromTheme(getContext(), R.attr.title_bar_title_size, AndroidTools.dip2px(18));
    }

    private boolean getDefaultEnableDivider() {
        return ResourceUtils.getBoolFromTheme(getContext(), R.attr.title_bar_enable_divider, true);
    }

    private float getDefaultRightTextSize() {
        return ResourceUtils.getDimissionFromTheme(getContext(), R.attr.title_bar_right_text_size, AndroidTools.dip2px(16));
    }

    private int getDefaultRightTextColor() {
        return ResourceUtils.getColorFromTheme(getContext(), R.attr.title_bar_right_text_color, Color.parseColor("#535353"));
    }

    private int getDefaultRightPressTextColor() {
        return ResourceUtils.getColorFromTheme(getContext(), R.attr.title_bar_right_text_color_press, Color.parseColor("#535353"));
    }
